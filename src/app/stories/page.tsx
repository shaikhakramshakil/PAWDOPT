    ...
    <div className="space-y-8">
      ...
      <div className="card p-6 bg-card-mint">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { text: "The process was so smooth and the staff was incredibly helpful!", author: "Vikram S." },
            { text: "I found my soulmate in a furry body. Thank you Pawdopt!", author: "Ananya R." },
            { text: "Best decision ever. Our rescue dog completed our family.", author: "The Patel Family" },
          ].map((testimonial, i) => (
